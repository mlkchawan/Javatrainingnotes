...
def extract_and_load_to_dataframe(**kwargs):
    ...
    #mysql_query =f"SELECT * FROM subscription_services WHERE modified_at >= CURDATE() - INTERVAL 2 YEAR"

    mysql_query =f"SELECT * FROM promos where date(created_at) > '2023-01-01' "
